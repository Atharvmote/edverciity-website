    ...
    return (
        <>
            ...
            <div className="simple-dropdown">
                <a href="#nandanvan" className="simple-item">Nandanvan</a>
                <a href="#sadar" className="simple-item">Sadar</a>
            </div>

            {/* 🔹 Nandanvan Section */}
           <section id="nandanvan" className="contactsection1">
                <div className="contactsection1content">
                    <div className="contactsection1box1">
                        <h2>NANDANVAN</h2><br />
                        <p>
                            1st floor, MB Tower, Nandanvan Main Rd,<br />
                            Mire Layout,Jawahar Nagar,<br />
            ...
            <section className="contactsection2">
                ...
                <div className="d1">
                    <h2>GUJARAT</h2><br />
                    <p>
                        301 3rd Floor, Bhuleshwar Complex, Halar Rd, beside
                        Bhulshwar Temple, Halar, Kapadia Chal,<b> Valsad</b>,
                        Gujarat 396001
                    </p><br />
                    <p>
                        K. P. Tower, 303, 3rd floor Gandhi Chowk, Station Char Rasta,
                        Silvasa Rd, Rd, Imran Nagar, <b>Vapi</b>, Gujarat 396195
                    </p>
                </div><br />
                ...
                <div className="d2">
                    ...
                    <p>
                        Block No. 5, 1st Floor, Mangalwari Complex 1, A-Wing, Sadar,
                        <b>Nagpur</b>, Maharashtra 440001
                    </p><br />
                </div><br />
                ...
                <div className="d3">
                    ...
                    <p>
                        th Floor, KP Arcade, KBC-25, Kanpur - Lucknow Rd, Sector B,
                        LDA Colony, Alambagh,<b>Lucknow</b>, Uttar Pradesh
                        226012
                    </p><br />
                    <p>
                        Building no. 26, Bharwara, Vigyan Khand, Gomti Nagar,
                        <b>Lucknow</b>, Uttar Pradesh 226010
                    </p><br />
                    <p>
                        G-12, Murli Bhawan, 10A Ashok Marg, near Sree Rama Towers,
                        Hazratganj, <b>Lucknow</b>, Uttar Pradesh 226001
                    </p>
                </div>
            </section>

            {/* 🔹 Sadar Section */}
         <section id="sadar" className="contactsection3"> 
                <div className="contactsection3content">
                    ...
                    <div className="contactsection3box2">
                        <h2>SADAR</h2><br />
                        <p>
                            1st Floor, A-Wing, Mangalwari Complex,<br /> Sadar,
